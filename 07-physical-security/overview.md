...
_Example:_  
This lab explores the topic of Physical Security within the Architecture & Design domain, using practical tools and scenarios.
...
`Security+` `Physical Security` `Architecture & Design`
