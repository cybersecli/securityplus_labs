...
_Example:_  
This lab explores the topic of Logging & Monitoring within the Security Operations domain, using practical tools and scenarios.
...
`Security+` `Logging & Monitoring` `Security Operations`
